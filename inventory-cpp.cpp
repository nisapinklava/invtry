...
void buatBarang()	{
	int i;
	cout << "ID          : "; cin >> barang.ID_barang;
	cout << "Nama        : "; cin.ignore(); getline(cin,barang.nama);
	cout << "Harga       : "; cin >> barang.harga;
	cout << "Stock       : "; cin >> barang.stock;
	cout << "Kedaluwarsa : "; cin >> barang.tExpired;
	cout << "\n";
}
...
void buatAdmin()	{
	cout << "Nama : "; cin.ignore(); getline(cin, uAdmin.nama);
	cout << "No. Identitas : "; cin >> uAdmin.no_id;
	cout << "Alamat : ";  cin.ignore(); getline(cin, uAdmin.alamat);
	cout << "username : "; cin >> uAdmin.username; 
	cout << "Password : "; cin >> uAdmin.password;
	cout << "\n";
}
...
void buatPegawai()	{
	cout << "Nama : "; cin.ignore(); getline(cin,uPegawai.nama);
	cout << "No. Identitas : "; cin >> uPegawai.no_id;
	cout << "Alamat : ";  cin.ignore(); getline(cin,uPegawai.alamat);
	cout << "username : "; cin >> uPegawai.username; 
	cout << "Password : "; cin >> uPegawai.password;
}
						...
						switch (pil2)	{
							case 1 : cout << "\nKELOLA BARANG\n1.Daftar Barang\n2.Tambah\n3.Perbarui\n4.Cari\n5.Hapus\n6.Kembali\n";
									 ...
									 while (status3 == 0)	{ // Kelola barang
										...
										cin >> pil3;
										switch(pil3)	{
											case 1: bacaDataBarang();
											break;
											case 2: cout << "Silahkan masukkan data barang.\n";
													simpanDataBarang();
											break;
											case 3: cout << "Masukkan ID barang diperbarui: ";
													cin >> i;
													perbaruiDataBarang(i);
											break;
											case 4: cout << "Masukkan ID barang dicari: ";
													cin >> i;
													cariBarang(i);
											break;
											case 5: cout << "Masukkan ID barang dihapus: ";
													cin >> i;
													hapusDataBarang(i);
											break;
											case 6: status3 = 1;
							...
							case 2: cout << "\nKELOLA ADMIN\n1.Daftar Admin\n2.Tambah Admin\n3.Hapus Admin\n4.Kembali\n";
									...
									while (status3 == 0)	{
										...
										cin >> pil;
										switch(pil)	{
											case 1: bacaDataAdmin();
											break;
											case 2: cout << "Silahkan masukkan data Admin.\n";
													simpanDataAdmin();
											break;
											case 3: cout << "Masukkan No. Identitas Admin dihapus: ";
													cin >> i;
													hapusDataAdmin(i);
											case 4: status3 = 1;
											break;
							...
							case 3: cout << "\nKELOLA PEGAWAI\n1.Daftar Pegawai\n2.Tambah Pegawai\n3.Perbarui Data Pegawai\n4.Hapus Data Pegawai\n5.Kembali\n";
									...
									while (status3 == 0)	{
										...
										switch(pil)	{
											case 1: bacaPegawai();
											break;
											case 2: cout << "Silahkan masukkan data Pegawai.\n";
													simpanPegawai();
											break;
											case 3: cout << "Masukkan No. Identitas Pegawai diperbarui: ";
													cin >> i;
													perbaruiDataPegawai(i);
											break;
											case 4: cout << "Masukkan No. Identitas Pegawai dihapus: ";
													cin >> i;
													hapusDataPegawai(i);
											break;
											case 5: status3 = 1;
